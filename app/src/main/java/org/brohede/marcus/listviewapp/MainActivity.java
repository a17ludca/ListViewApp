...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] mountainHeights ={"14692ft","15777ft","20310ft"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final List<String> mHeight = new ArrayList<String>(Arrays.asList(mountainHeights));

        ArrayAdapter adapter = new ArrayAdapter(getApplicationContext(),R.layout.list_item_textview,
                R.id.my_item_textview,mNames);
        ...
        myListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int item, long id) {
                ...
                CharSequence text = mLoc.get(item)+" "+mHeight.get(item);
